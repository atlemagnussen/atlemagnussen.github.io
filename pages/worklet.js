registerPaint('static-gradient', class StaticGradient {
    ...
    static get inputProperties() {
        return ["--static-gradient-direction","--static-gradient-color","--static-gradient-size"]
    }

    parseProps(props) {
        return ["--static-gradient-direction","--static-gradient-color","--static-gradient-size"].map(param => {
            let prop = props.get(param)
            if (prop)
